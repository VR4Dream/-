 ...
 * 邮箱：529844698@qq.com
 */
public class ParallaxFooter extends FrameLayout implements PtrUIHandler {
    ...
    public ParallaxFooter(Context context, AttributeSet attrs) {
    ...
    public ParallaxFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tip2 = context.getResources().getString(R.string.loading_tip3);
        tip3 = context.getResources().getString(R.string.loading_tip4);
        initialize();
    }
